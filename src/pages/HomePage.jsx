...
export default function HomePage() {
  ...
  return (
    <Box>
      ...
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          <ScrollReveal direction="up" duration={0.8}>
            ...
            >
              Chizzy's Nails is a refined nail brand rooted in Gloss and Grace
            </Typography>
          </ScrollReveal>
          ...
          <ScrollReveal direction="up" delay={0.3} duration={0.8}>
            <Box sx={{ display: 'flex', gap: 3, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Button sx={ctaButtonSx} onClick={() => navigate('/services')}>
                View Service Menu
              </Button>
            </Box>
          </ScrollReveal>
      ...
      <Box
        id="contact-section"
        sx={{ py: 8, backgroundColor: '#FFF0F5' }}
      >
          ...
          <Grid container spacing={6} justifyContent="center" textAlign="center">
            <Grid item xs={12} md={4}>
              <ScrollReveal direction="up" delay={0}>
                <Box>
                  <PhoneIcon sx={{ fontSize: 40, color: '#E91E8C', mb: 1 }} />
                  <Typography
                    variant="h5"
                    sx={{ fontFamily: '"Georgia", serif', fontWeight: 700, mb: 2, color: '#4A0E4E' }}
                  >
                    Contact Info
                  </Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1, mb: 1 }}>
                    <PhoneIcon sx={{ fontSize: 18, color: '#E91E8C' }} />
            ...
            <Grid item xs={12} md={4}>
              <ScrollReveal direction="up" delay={0.15}>
                <Box>
                  <AccessTimeIcon sx={{ fontSize: 40, color: '#E91E8C', mb: 1 }} />
                  <Typography
                    variant="h5"
                    sx={{ fontFamily: '"Georgia", serif', fontWeight: 700, mb: 2, color: '#4A0E4E' }}
                  >
                  ...
                  <Typography>Monday – Friday: 11:00 AM – 5:00 PM</Typography>
                  <Typography>Saturdays & Sundays: 12:00 PM – 6:00 PM</Typography>
                </Box>
              </ScrollReveal>
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              <ScrollReveal direction="up" delay={0.3}>
                <Box>
                  <LocationOnIcon sx={{ fontSize: 40, color: '#E91E8C', mb: 1 }} />
                  <Typography
                    variant="h5"
                    sx={{ fontFamily: '"Georgia", serif', fontWeight: 700, mb: 2, color: '#4A0E4E' }}
                  >
                  ...
                  <Typography>Opp car-wash, Bustop, Abule-egba,</Typography>
        ...
        <Container maxWidth="md">
          <ScrollReveal direction="up">
            <Box sx={{ textAlign: 'center', mb: 5 }}>
              ...
              >
                Here you can find answers to frequently asked questions. If you cannot find
                the answer, feel free to contact us via email or phone.
              </Typography>
            </Box>
          </ScrollReveal>
              ...
              >
                ...
                <Box
                  ...
                  sx={{
                    ...
                    py: 2.5,
                    cursor: 'pointer',
                    backgroundColor: openFaq === index ? '#FFF0F5' : '#fff',
                ...
                >
                  ...
                  <IconButton
                    size="small"
                    sx={{
                      backgroundColor: openFaq === index ? '#E91E8C' : 'transparent',
                      border: '2px solid #E91E8C',
                ...
                <Collapse in={openFaq === index}>
                  <Box sx={{ px: 3, pb: 3, pt: 1, backgroundColor: '#FFF0F5' }}>
                    <Typography
                      sx={{
                        color: '#444',
                        fontSize: '0.95rem',
