		...
		<Box sx={{ pt: 12 }}>
			...
			<Box sx={{ textAlign: "center", py: 6, backgroundColor: "#fff" }}>
				...
				<ScrollReveal direction="up" delay={0.15}>
					...
					>
						Explore our range of nail services designed to give you the
						perfect look. From classic manicures to custom nail art, we
						have something for everyone. Book your appointment today and
						let us bring your nail vision to life.
					</Typography>
				</ScrollReveal>
				{!user && (
